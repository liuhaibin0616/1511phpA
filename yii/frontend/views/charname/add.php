...
<div class="right">
    <div class="search-box">
       <form method="post" action="<?php echo Url::to(['charname/add_do']);
 ?>">
            <ul>
                <li>
                    <span>请输入字段名称：</span>
                ...
                <li>
                    <span>请输入字段默认值：</span>
                    <input class="filed-name" type="text" name='value'>
                </li>
                <li>
                    <span>请选择字段类型：</span>
                    <select name="type" id="">
                ...
                <li>
                    <span>请选择填写长度范围：</span>
                    <input class="length" type="text" value="" name="xiao" placeholder="请输入最小长度">
                    ~
                    <input class="length" type="text" value="" name="da" placeholder="请输入最大长度">
                </li>
                <li>
