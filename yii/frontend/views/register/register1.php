...
<div class="main">
    <form method="post" action="<?php echo Url::to(['register/add2']);
 ?>">
        <p>
            <span>昵称：</span>
        ...
        <p>
            <span>生日：</span>
            <input type="text"  name="birthday" placeholder="请输入您的出生年月日，格式 xxxx-xx-xx">
        </p>
        <p>
            <span>工作地址：</span>
        ...
        <p class="handler-button">
            <a class="a_button" href="./register.php">上一步</a>
